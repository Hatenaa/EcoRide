...
$pageTitle = 'Achat de Crédits | EcoRide';
...
<body class="min-h-screen bg-[#f4fef7] flex flex-col items-center justify-center p-4 md:p-8">
    ...
    <div class="eco-bg eco-bg-3">
            ...
            <path d="M12 3C10.22 3 8.47991 3.52784 6.99987 4.51677C5.51983 5.50571 4.36628 6.91131 3.68509 8.55585C3.0039 10.2004 2.82567 12.01 3.17294 13.7558C3.5202 15.5016 4.37737 17.1053 5.63604 18.364C6.89472 19.6226 8.49836 20.4798 10.2442 20.8271C11.99 21.1743 13.7996 20.9961 15.4442 20.3149C17.0887 19.6337 18.4943 18.4802 19.4832 17.0001C20.4722 15.5201 21 13.78 21 12C21 9.61305 20.0518 7.32387 18.364 5.63604C16.6761 3.94821 14.3869 3 12 3ZM12 19C10.4178 19 8.87104 18.5308 7.55544 17.6518C6.23985 16.7727 5.21447 15.5233 4.60897 14.0615C4.00347 12.5997 3.84504 10.9911 4.15372 9.43928C4.4624 7.88743 5.22433 6.46197 6.34315 5.34315C7.46197 4.22433 8.88743 3.4624 10.4393 3.15372C11.9911 2.84504 13.5997 3.00347 15.0615 3.60897C16.5233 4.21447 17.7727 5.23985 18.6518 6.55544C19.5308 7.87104 20 9.41775 20 11C20 13.1217 19.1572 15.1566 17.6569 16.6569C16.1566 18.1571 14.1217 19 12 19Z" fill="#22c55e"/>
                    ...
                    <?php 
                        ...
                        if (isset($_SESSION['message'])) {
                            ...
                            echo "<div class='alert alert-{$type} fade show mt-3' role='alert' style='margin-bottom: -30px;'>
        ...
        <!-- Header -->
        <div class="text-center mb-8" style="padding-top: 50px;">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-800 mb-2">Simple et transparent!</h1>
            <p class="text-gray-600 text-lg">
                Obtenez des crédits dès maintenant pour garantir votre place instantanément et profiter d’un covoiturage sans stress.
            </p>
        </div>

        <div class="w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center gap-8 px-4">
            <!-- Free Plan -->
            <div class="glass-card w-full md:w-1/3 relative p-8 transition-all duration-300 hover:scale-[1.02]">
                <div class="flex flex-col h-full">
                    <div class="mb-6">
                        <h3 class="text-2xl font-semibold text-gray-700">Gratuit</h3>
                        <p class="text-gray-500 mt-2">Idéal pour tester notre service</p>
                    </div>
                    
                    <div class="mb-8">
                        <span class="text-4xl font-bold text-gray-800">0€</span>
                        <span class="text-gray-500">/toujours</span>
                    </div>
                    
                    <ul class="space-y-3 mb-8 flex-grow">
                        <li class="feature-item flex items-center">
                            <i class="fas fa-check-circle text-green-500 mr-3"></i>
                            <span class="text-gray-700">20 crédits de Bienvenue</span>
                        </li>
                        <li class="feature-item flex items-center">
                            <i class="fas fa-check-circle text-green-500 mr-3"></i>
                        ...
                        <li class="feature-item flex items-center">
                            <i class="fas fa-check-circle text-green-500 mr-3"></i>
                            <span class="text-gray-700">Accès communautaire</span>
                        </li>
                        <li class="feature-item flex items-center opacity-50">
                            <i class="fas fa-times-circle text-gray-400 mr-3"></i>
                            <span class="text-gray-500">Réservation prioritaire</span>
                        </li>
                        <li class="feature-item flex items-center opacity-50">
                            <i class="fas fa-times-circle text-gray-400 mr-3"></i>
                            <span class="text-gray-500">Rapports carbone</span>
                        </li>
                    </ul>
                    
                    <button class="
                    text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 
                    focus:ring-gray-100 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 
                    dark:text-black dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700
                    ">
                        Essayons Gratuitement
                    </button>
                </div>
            </div>
            ...
            <div class="glass-card w-full md:w-1/3 relative p-8 transition-all duration-300 hover:scale-[1.02]">
                ...
                <div class="flex flex-col h-full">
                    <div class="mb-6">
                        <h3 class="text-2xl font-semibold text-gray-700">Pack</h3>
                        <p class="text-gray-500 mt-2">Pour les cavaliers occasionnels</p>
                    </div>
                    ...
                    <ul class="space-y-3 mb-8 flex-grow">
                        <li class="feature-item flex items-center">
                            <i class="fas fa-check-circle text-green-500 mr-3"></i>
                            <span class="text-gray-700">50 crédits de Boost</span>
                        </li>
                        <li class="feature-item flex items-center">
                            <i class="fas fa-check-circle text-green-500 mr-3"></i>
                        ...
                        <li class="feature-item flex items-center">
                            <i class="fas fa-check-circle text-green-500 mr-3"></i>
                            <span class="text-gray-700">Réservation prioritaire</span>
                        </li>
                        <li class="feature-item flex items-center opacity-50">
                            <i class="fas fa-times-circle text-gray-400 mr-3"></i>
                            <span class="text-gray-500">Rapports carbone</span>
                    ...
                    <button class="btn-eco text-white font-semibold py-3 px-8 rounded-full text-lg transition-all duration-300 transform hover:scale-105"> 
            ...
            <!-- Subscription Plan -->
            <div class="glass-card w-full md:w-1/3 relative p-8 transition-all duration-300 hover:scale-[1.02] border-2 border-blue-100">
                <div class="flex flex-col h-full">
                    <div class="mb-6">
                        <h3 class="text-2xl font-semibold text-gray-700">Ultimate</h3>
                        <p class="text-gray-500 mt-2">Pour les utilisateurs fréquents</p>
                    </div>
                    ...
                    <ul class="space-y-3 mb-8 flex-grow">
                        <li class="feature-item flex items-center">
                            <i class="fas fa-check-circle text-green-500 mr-3"></i>
                            <span class="text-gray-700">Crédits de trajet illimités</span>
                        </li>
                        <li class="feature-item flex items-center">
                            <i class="fas fa-check-circle text-green-500 mr-3"></i>
                            <span class="text-gray-700">Assistance premium 24/7</span>
                        </li>
                        <li class="feature-item flex items-center">
                            <i class="fas fa-check-circle text-green-500 mr-3"></i>
                            <span class="text-gray-700">Accès à la communauté VIP</span>
                        </li>
                        <li class="feature-item flex items-center">
                            <i class="fas fa-check-circle text-green-500 mr-3"></i>
                            <span class="text-gray-700">Réservation prioritaire</span>
                        ...
                        <li class="feature-item flex items-center">
                            <i class="fas fa-check-circle text-green-500 mr-3"></i>
                            <span class="text-gray-700">Rapports détaillés CO₂</span>
                        </li>
                    </ul>
                    ...
                    dark:text-black dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700
                    ">
                    Débridez vos courses dès maintenant!
                    </button>
                </div>
            </div>
        </div>
        ...
        <p>Utilisateur connecté : <strong><?php echo $_SESSION['loggedInUser']['firstname'] . ' ' . $_SESSION['loggedInUser']['name']; ?></strong></p>

        <!-- Formulaire pour la gestion des crédits -->
        <form method="POST" action="credits.php">
            <label for="amount">Montant (si applicable) :</label>
            ...
            <select name="action">
                ...
                <option value="view">Consulter les crédits</option>
            </select><br><br>
